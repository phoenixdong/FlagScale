...
def test_equal(test_path, test_type, test_model, test_case):
    ...
    test_result_path = os.path.join(test_path, test_type, test_model, "results_test", test_case)
    ...
    gold_value_path = os.path.join(test_path, test_type, test_model, "results_gold", test_case+".json")
